    ...
    <div id="authentication-box" class="authentication-style1 img-responsive ">
        <div class="authentication-box-wrapper">
                    ...
                    <div class="authentication-body">
                        ...
                        <form class="form" role="form" method="POST">
                            <div class="form-group floating-label">
                                <input type="text" class="form-control" id="regular2" name="alias" required />
                            ...
                            <div class="form-group floating-label">
                                <input type="password" class="form-control" id="password2" name="confirmaContrasena" required />
            ...
            <div class="text-center">
                ...
                <a href="login.php" class="text-default-bright">Iniciar sesión</a>
            </div>
        </div>
